...
import { leadership, bots, projects, posts, publicity, sponsors, donations } from '$lib/server/schema';
import { count, eq } from 'drizzle-orm';
import type { PageServerLoad } from './$types';

export const load: PageServerLoad = async () => {
	const [[leadershipCount], [botsCount], [projectsCount], [postsCount], [publishedCount], [publicityCount], [sponsorsCount], [donationsCount]] = await Promise.all([
